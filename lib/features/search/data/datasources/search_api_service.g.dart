...
class _SearchApiService implements SearchApiService {
  ...
  Future<PaginatedResponse<HashtagModel>> searchHashtags({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaginatedResponse<HashtagModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/search/hashtags',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PaginatedResponse<HashtagModel> _value;
    try {
      _value = PaginatedResponse<HashtagModel>.fromJson(
        _result.data!,
        (json) => HashtagModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<TrendingHashtagsModel> getTrendingHashtags({int limit = 10}) async {
    final _extra = <String, dynamic>{};
  ...
  Future<List<RecentSearchModel>> getRecentSearches({int limit = 10}) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<RecentSearchModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/search/recent',
  ...
  @override
  Future<void> saveRecentSearch(SaveRecentSearchRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<SearchSuggestionsModel> getSuggestions({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SearchSuggestionsModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/search/suggestions',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SearchSuggestionsModel _value;
    try {
      _value = SearchSuggestionsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
