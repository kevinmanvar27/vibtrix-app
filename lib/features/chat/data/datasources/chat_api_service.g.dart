...
class _ChatApiService implements ChatApiService {
  ...
  Future<PaginatedResponse<ChatModel>> getChats({
    ...
    final _options = _setStreamType<PaginatedResponse<ChatModel>>(
    ...
    late PaginatedResponse<ChatModel> _value;
    try {
      _value = PaginatedResponse<ChatModel>.fromJson(
        _result.data!,
  ...
  Future<ChatModel> createChat(CreateChatRequest request) async {
    ...
    final _options = _setStreamType<ChatModel>(
  ...
  @override
  Future<ChatModel> createGroupChat(CreateGroupChatRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<void> muteChat(String chatId, MuteChatRequest? request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<MutedStatusResponse> isChatMuted(String chatId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MutedStatusResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/chats/${chatId}/muted',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MutedStatusResponse _value;
    try {
      _value = MutedStatusResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<PaginatedResponse<MessageModel>> getMessages(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaginatedResponse<MessageModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PaginatedResponse<MessageModel> _value;
    try {
      _value = PaginatedResponse<MessageModel>.fromJson(
        _result.data!,
  ...
  @override
  Future<UnreadCountResponse> getTotalUnreadCount() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<UnreadCountResponse> getUnreadCount(String chatId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> blockUserInChat(String chatId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> unblockUserInChat(String chatId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<List<ChatParticipantModel>> getParticipants(String chatId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ChatParticipantModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/chats/${chatId}/participants',
    ...
    late List<ChatParticipantModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                ChatParticipantModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
